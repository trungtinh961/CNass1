...
public class MainGui {
    ...
    private JButton btnChat, btnExit, btnAddFriend;
    ...
    public static void resetListActive() {
        modelActive.clear();
    ...
    private void initialize() {
        ...
        btnAddFriend.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        ...
        btnAddFriend.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                for (int i = 0; i < size; i++) {
                    if (name.equals(Client.clientarray.get(i).getName())) {
                        try {
                            clientNode.intialNewAddFriend(Client.clientarray.get(i).getHost(), Client.clientarray.get(i).getPort(), name);
                            return;
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
        ...
        btnAddFriend.setIcon(new javax.swing.ImageIcon(MainGui.class.getResource("/image/register.png")));
        btnAddFriend.setBounds(50, 370, 150, 44);
        frameMainGui.getContentPane().add(btnAddFriend);

        lblLogo = new JLabel("CHAT WITH STRANGER");
        ...
        lblFriendList = new JLabel("List friend active now: ");
        lblFriendList.setForeground(new Color(100, 149, 237));
        lblFriendList.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        lblFriendList.setBounds(320, 123, 156, 16);
        frameMainGui.getContentPane().add(lblFriendList);

        listFriend = new JList<>(modelFriend);
        listFriend.setFont(new Font("Segoe UI", Font.PLAIN, 15));
        listFriend.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                String value = (String) listFriend.getModel().getElementAt(listFriend.locationToIndex(e.getPoint()));
                txtNameFriend.setText(value);
            }
        });
        listFriend.setBounds(250, 152, 220, 250);
        ...
        listActive.setBounds(12, 152, 220, 200);
